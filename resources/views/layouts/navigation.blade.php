                            ...
                            <div class="max-h-96 overflow-y-auto w-80">
                                @forelse (auth()->user()->unreadNotifications as $notification)
                                    <form action="{{ route('notifications.read', $notification->id) }}" method="POST">
                                        @csrf
                                        <button type="submit"
                                            class="flex items-start gap-3 w-full text-left px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 border-b border-gray-100 dark:border-gray-700 last:border-b-0">
                                            <div
                                                class="h-8 w-8 rounded-full bg-yellow-50 dark:bg-yellow-900/30 flex items-center justify-center shrink-0 mt-0.5">
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                <p class="text-xs text-gray-500 mt-0.5">
                                                    Interview:
                                                    {{ \Carbon\Carbon::parse($notification->data['interview_date'])->format('M d, Y g:i A') }}
                                                </p>
                                            </div>
                                        </button>
                                    </form>
                                @empty
                                    <div class="px-4 py-6 text-center">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-6 w-6 mx-auto text-gray-300 mb-1" fill="none"
